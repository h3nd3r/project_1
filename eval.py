...
@traceable
def session_engagement_evaluator(run: Run, example: Example) -> dict:
    inputs = example.inputs['input']
    outputs = example.outputs['output']
    ...
    Based on the above information, evaluate the model's output for engagement with the user. 
    Provide a score from 0 to 10, where 0 is completely non-compliant and 10 is perfectly compliant.
    Also provide a brief explanation for your score.
...
experiment_prefix = "Python project 1 experiment"

# List of evaluators to score the outputs of target task
evaluators = [
    prompt_compliance_evaluator,
    session_engagement_evaluator
]
